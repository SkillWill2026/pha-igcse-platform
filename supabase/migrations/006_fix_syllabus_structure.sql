...
-- ────────────────────────────────────────────
-- 6. Seed 72 subtopics
--    Insert into both `name` (original NOT NULL col) and `title` (code-facing col)
-- ────────────────────────────────────────────
insert into public.subtopics (topic_id, ref, name, title, tier, sort_order)
select t.id, s.ref, s.title, s.title, s.tier, s.sort_order
