...
// Lazy load react-pdf components to avoid build issues
        ...
        <div className="flex-1 overflow-auto p-4">
          ...
          {pdfUrl && !error && (
            <div className="space-y-4">
              {/* PDF Viewer */}
              <div className="flex justify-center bg-gray-100 rounded-lg p-4 relative">
                <PDFDocument file={pdfUrl} onLoadSuccess={onDocumentLoadSuccess}>
                  <PDFPage pageNumber={currentPage} width={700} />
                </PDFDocument>
